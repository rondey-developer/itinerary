...
<head>
  ...
  <style>
    ...
    :root {
      --primary: #9b223e;
      --primary-hover: #7e182f;
      --primary-subtle: rgba(155, 34, 62, 0.07);
      --primary-glow: rgba(155, 34, 62, 0.22);
      
      --bg-page: #faf9f6;
      --bg-surface: #ffffff;
      --bg-subtle: #f4f2ee;
      --bg-subtle-hover: #ece9e3;
      
      --border-subtle: rgba(0, 0, 0, 0.07);
      --border-medium: rgba(0, 0, 0, 0.12);
      --border-focus: rgba(155, 34, 62, 0.35);
      ...
      --shadow-sm: 0 2px 6px -1px rgba(0, 0, 0, 0.05), 0 1px 3px rgba(0, 0, 0, 0.03);
      --shadow-md: 0 6px 20px -3px rgba(0, 0, 0, 0.07), 0 2px 6px -1px rgba(0, 0, 0, 0.03);
      --shadow-lg: 0 16px 36px -6px rgba(0, 0, 0, 0.10), 0 4px 12px -2px rgba(0, 0, 0, 0.04);
      
      --radius-sm: 8px;
      --radius-card: 14px;
      --radius-pill: 9999px;
      
      --font-sans: -apple-system, BlinkMacSystemFont, "SF Pro Text", "Hiragino Sans", "Hiragino Kaku Gothic ProN", "Yu Gothic Medium", "Noto Sans TC", sans-serif;
      --font-display: -apple-system, BlinkMacSystemFont, "SF Pro Display", "Hiragino Sans", "Hiragino Kaku Gothic ProN", "Noto Sans TC", sans-serif;
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn-nav-primary {
      background: linear-gradient(135deg, #9b223e 0%, #7e182f 100%);
      color: #fff;
      border: 1px solid rgba(155, 34, 62, 0.4);
      box-shadow: 0 2px 8px var(--primary-glow);
    }
    .btn-nav-primary:hover {
      background: linear-gradient(135deg, #a82745 0%, #8c1b35 100%);
      color: #fff;
      transform: translateY(-1px);
...
<body>
  ...
  <header class="top-navbar">
    <div class="brand-group">
      ...
      <div>
        <h1 class="brand-title">東京 & 草津 浪漫雙人行</h1>
      </div>
  ...
  <div class="app-viewport">
    ...
    <main class="map-container">
      ...
      <div class="ofm-switcher-control">
        ...
        <button class="ofm-style-btn active" id="ofm-btn-liberty" onclick="switchOpenFreeMapStyle('liberty')">Liberty</button>
        <button class="ofm-style-btn" id="ofm-btn-bright" onclick="switchOpenFreeMapStyle('bright')">Bright</button>
        <button class="ofm-style-btn" id="ofm-btn-positron" onclick="switchOpenFreeMapStyle('positron')">Positron</button>
      </div>
            ...
            <div class="venue-card" id="card-shanes-burg" onclick="selectStopLeg('shanes-burg')">
              ...
              <div class="card-footer-row">
                ...
                <div class="venue-actions">
                  <button class="btn-action-pill" style="background:#fff0f3; color:#9e2846; border-color:#fecdd3; font-weight:700;" onclick="jumpToMapFromCard(\'shanes-burg\', event)">🗺️ 路線</button>
          ...
          <div class="day-block-body">
            ...
            <div class="venue-card" id="card-jiro" onclick="selectStopLeg('jiro')">
              ...
              <div class="card-footer-row">
                ...
                <div class="venue-actions">
                  <button class="btn-action-pill" style="background:#fff0f3; color:#9e2846; border-color:#fecdd3; font-weight:700;" onclick="jumpToMapFromCard(\'jiro\', event)">🗺️ 路線</button>
            ...
            <div class="venue-card" id="card-tokyo-tower" onclick="selectStopLeg('tokyo-tower')">
              ...
              <div class="card-footer-row">
                ...
                <div class="venue-actions">
                  <button class="btn-action-pill" style="background:#fff0f3; color:#9e2846; border-color:#fecdd3; font-weight:700;" onclick="jumpToMapFromCard(\'tokyo-tower\', event)">🗺️ 路線</button>
            ...
            <div class="venue-card" id="card-virtu" onclick="selectStopLeg('virtu')">
              ...
              <div class="card-footer-row">
                ...
                <div class="venue-actions">
                  <button class="btn-action-pill" style="background:#fff0f3; color:#9e2846; border-color:#fecdd3; font-weight:700;" onclick="jumpToMapFromCard(\'virtu\', event)">🗺️ 路線</button>
            ...
            <div class="venue-card" id="card-kura-sushi" onclick="selectStopLeg('kura-sushi')">
              ...
              <div class="card-footer-row">
                ...
                <div class="venue-actions">
                  <button class="btn-action-pill" style="background:#fff0f3; color:#9e2846; border-color:#fecdd3; font-weight:700;" onclick="jumpToMapFromCard(\'kura-sushi\', event)">🗺️ 路線</button>
          ...
          <div class="day-block-body">
            ...
            <div class="venue-card" id="card-disneysea" onclick="selectStopLeg('disneysea')">
              ...
              <div class="card-footer-row">
                ...
                <div class="venue-actions">
                  <button class="btn-action-pill" style="background:#fff0f3; color:#9e2846; border-color:#fecdd3; font-weight:700;" onclick="jumpToMapFromCard(\'disneysea\', event)">🗺️ 路線</button>
            ...
            <div class="venue-card" id="card-ss-columbia" onclick="selectStopLeg('ss-columbia')">
              ...
              <div class="card-footer-row">
                ...
                <div class="venue-actions">
                  <button class="btn-action-pill" style="background:#fff0f3; color:#9e2846; border-color:#fecdd3; font-weight:700;" onclick="jumpToMapFromCard(\'ss-columbia\', event)">🗺️ 路線</button>
          ...
          <div class="day-block-body">
            ...
            <div class="venue-card" id="card-sakurai" onclick="selectStopLeg('sakurai')">
              ...
              <div class="card-footer-row">
                ...
                <div class="venue-actions">
                  <button class="btn-action-pill" style="background:#fff0f3; color:#9e2846; border-color:#fecdd3; font-weight:700;" onclick="jumpToMapFromCard(\'sakurai\', event)">🗺️ 路線</button>
            ...
            <div class="venue-card" id="card-yubatake" onclick="selectStopLeg('yubatake')">
              ...
              <div class="card-footer-row">
                ...
                <div class="venue-actions">
                  <button class="btn-action-pill" style="background:#fff0f3; color:#9e2846; border-color:#fecdd3; font-weight:700;" onclick="jumpToMapFromCard(\'yubatake\', event)">🗺️ 路線</button>
          ...
          <div class="day-block-body">
            ...
            <div class="venue-card" id="card-wolfgang" onclick="selectStopLeg('wolfgang')">
              ...
              <div class="card-footer-row">
                ...
                <div class="venue-actions">
                  <button class="btn-action-pill" style="background:#fff0f3; color:#9e2846; border-color:#fecdd3; font-weight:700;" onclick="jumpToMapFromCard(\'wolfgang\', event)">🗺️ 路線</button>
            ...
            <div class="venue-card" id="card-shibuya" onclick="selectStopLeg('shibuya')">
              ...
              <div class="card-footer-row">
                ...
                <div class="venue-actions">
                  <button class="btn-action-pill" style="background:#fff0f3; color:#9e2846; border-color:#fecdd3; font-weight:700;" onclick="jumpToMapFromCard(\'shibuya\', event)">🗺️ 路線</button>
            ...
            <div class="venue-card" id="card-new-york-bar" onclick="selectStopLeg('new-york-bar')">
              ...
              <div class="card-footer-row">
                ...
                <div class="venue-actions">
                  <button class="btn-action-pill" style="background:#fff0f3; color:#9e2846; border-color:#fecdd3; font-weight:700;" onclick="jumpToMapFromCard(\'new-york-bar\', event)">🗺️ 路線</button>
  ...
  <script>
    ...
    function selectStopLeg(spotId, autoScrollCard = true) {
      ...
      map.fitBounds(legBounds.pad(0.3), { animate: true, duration: 1.0 });
